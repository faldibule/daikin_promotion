...
{/* <nav class="navbar navbar-expand-lg navbar-dark, bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item"><a class="nav-link" aria-current="page" href="/daikin_promotion/pages/tentang.html">Tentang</a></li>
      <li class="nav-item">
        <div class="dropdown nav-link">
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">Single Split</a></li>
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">Multi Split</a></li>
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">Air Purifier</a></li>
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">Sky Air</a></li>
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">VRV</a></li>
            <li><hr class="dropdown-divier"></li>
            <li><a class="dropdown-item" href="/daikin_promotion/pages/single_split/index.html">Packaged Air Conditioner</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Download Katalog</a>
      </li>
    </ul>
  </div>
</nav> */}
...
// <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
//         <div class="container mt-3">
//           <a class="navbar-brand mb-3" href="#">Daikin</a>
...
//             <ul class="navbar-nav">
//               <li class="nav-item">
//                 <a class="nav-link" aria-current="page" href="/daikin_promotion/pages/tentang.html">Tentang</a>
//               </li>
//               <li class="nav-item">
//                 <div class="dropdown nav-link">
...
//                     <li><a class="dropdown-item" href="#">Multi Split</a></li>
//                     <li><hr class="dropdown-divider"></li>
//                     <li><a class="dropdown-item" href="#">Air Purifier</a></li>
//                     <li><hr class="dropdown-divider"></li>
//                     <li><a class="dropdown-item" href="#">Sky Air</a></li>
//                     <li><hr class="dropdown-divider"></li>
//                     <li><a class="dropdown-item" href="#">VRV</a></li>
//                     <li><hr class="dropdown-divider"></li>
//                     <li><a class="dropdown-item" href="#">Packaged Air Conditioner</a></li>
//                   </ul>
//                 </div>
//               </li>
//               <li class="nav-item">
